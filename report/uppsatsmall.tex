...
In previous work within the area of OSS and requirement elicitation there are to highly relevant studies for this thesis.\{TODO: Brifely describe the two studys}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.7\textwidth]{all_commits_dist}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.7\textwidth]{all_additions_dist}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.7\textwidth]{all_deletions_dist}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.7\textwidth]{all_feature_proposers_dist}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.7\textwidth]{all_problem_reporters_dist}
