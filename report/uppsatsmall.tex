...
Our questions can be grouped into two categories. The first category (Q1 to Q2) is intended to compare the two projects on factors other than what we want to research. This is done because we want to ensure that our two projects are as similar as possible so that our results in fact illustrates a comparison of community- and firm-driven OSS projects.
\begin{itemize}
	\item[Q1:]\emph{How many LoC is it?}
	\item[Q2:]\emph{How many people wrote code?}
	\item[QX] Perhaps some more questions
	%TODO more questions?
\end{itemize}
%TODO
Here the second category will be explained.
\begin{itemize}
	...
	\item[Q4:]\emph{Is strict code ownership enforced?}
	\item[Q5:]\emph{Who proposes requirements?}
	\item[Q6:]\emph{How are requirements validated?}
	\item[Q7:]\emph{How are requirements documented?}
	
	Is there for an example a roadmap?
	\item[Q8:]\emph{How are requirements implemented?}
	\item[Q9:]\emph{Who reports bugs/defects?}
	\item[Q10:]\emph{Who fixes bugs/defects?}
	\item[Q6:]\emph{How long does it take to fix a bug/defect?}
\end{itemize}
