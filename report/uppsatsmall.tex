...
This section describes the two projects that we have conducted our case studies on. The two projects we investigated, Atom and NeoVim,  are open-source texteditors that are free too use and the source code from these projects are available too investigate on GitHub.
...
Neovim is a refactor of a highly configurable text editor called Vim. Vim itself are built to make creating and changing any kind of text very efficient. Neovim started 
%Explain Vim
