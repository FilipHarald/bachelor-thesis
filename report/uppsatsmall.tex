...
\begin{enumerate}[label=RQ\arabic*]
	...
	\item \emph{How can software companies benefit from engaging in OSS development?}
\end{enumerate}
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
\section{Analysis}
\label{sec:analysis}
In the previous section, we presented and described the results from our statistical and sample data gathering that we have conducted.
...
\newpage
\input{appendicies/sample_results_raw_data.tex}
