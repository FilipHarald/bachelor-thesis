...
Several data sources have been used to collect different type of data for this thesis. The biggest source of data for this thesis are Github, a web-based version-control and collaboration platform for software developers, which have provided us with data for both Atom and Neovim regarding the elicitation of requirement such as issues, contributions, developers, features and discussions. Data form Github have been used in two occasions. The first occasion are gatehering of statistical data from the Github API for both Atom and Neovim, the second occasion are gathering of sample data from Atom and Neovim. Both of the occasions are presented in the section \ref{subsec:data}.

We have also made further investigation in specific forums for each project. The Atom project have an official forum for discussion on their website, where you can find questions about features, issues, FAQ and more. The Neovim project don't have a offical forum for discussions, instead they refer their users to several sources depending the need they have, general discussions about neovim can be found on Reddit and via their google group mailing list, questions raised about features and issues regarding Neovim are raised on Github.
...
\begin{enumerate}[label=D\arabic*]
	...
	How many contributors are there in the project? We define a contributor as someone who has wrote code to the project. 
