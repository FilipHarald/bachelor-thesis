...
In section~\ref{sec:unforeseen}  we mentioned that the definitions used for categorising developers into peripheral and core might not be accurate. Therefore it would be appropriate to conduct a similar study to ours but instead using the definitions of developer categories which is presented in~\cite{Krishnamurthy2016}.
