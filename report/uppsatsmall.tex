...
D5
The result of feature proposals in table 5 and 6 shows that the total combined amount of features proposed in the projects where 46, 20 proposlas from the Atom project and 26 from the Neovim project. We can also see that the total of proposals coming from core developers (core dev) are 16, where there where 4 proposals in the Atom project and 12 in the Neovim project. From contributing developers (dev) there where a total of  23 proposals, 12 from the Atom project and 11 from the Neovim project. The total amount of proposlas from end users are a total of 7, 4 in the Atom project and 3 in the Neovim project. 
From table 7 we can see that the total amount of core developers proposing features where 2 in the Atom project and a total of 7 in the Neovim project. The biggest spread of unique users proposing in both project are from the group of contributing developers (dev) where a Atom had a total of 9 unique contribution developers and Neovim had
\begin{table}[h]
	\centering
	\begin{tabular}{ | l | c | c | }
		\hline
