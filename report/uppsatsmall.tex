...
% section intro
In this section we will discuss our findings in previous the section, their implications and their relevance to our first two research questions. Then we will discuss, based on the first two research questions, what this implies to our third research question.
...
When comparing to other study: Mozilla and OpenEMR has end-users that is not necessarily developers.
