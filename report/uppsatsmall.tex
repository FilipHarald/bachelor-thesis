...
\begin{table}[h]
	...
	\begin{tabular}{ | l | c | c | c |}
		\hline
		Data 		& Atom 	& Neovim 	& Difference			\\\hline
		Contributors 	& 349 	& 303 	& 46					\\\hline
		Commits 		& 31382 	& 7925 	& 23457				\\\hline
		Forks 		& 6218 	& 1586 	& 4632				\\\hline
		Stars 		& 35871 	& 22114 	& 13757				\\\hline
		Watching 		& 2021 	& 957 	& 1064				\\\hline
		Open Issues 	&1677 	& 599 	& 1078				\\\hline
		Pull Requests 	& 105 	& 169 	& 64					\\\hline
		LoC 			& 246741	& 57089 	& 189652\footnotemark	\\\hline
		Number of files & 579 	& 388 	& 191				\\
		\hline 
	\end{tabular}
	\caption{Project statistics found on Github as of March 2017.}
	\label{tab:github_stats}
\end{table}
\footnotetext{As mentioned in section \ref{neo_vim} Neovim is a product built on the text editor Vim. The result of this is that Neovim has a lot of code which has been transferred from Vim.}
...
\label{data_schema}
\label{subsec:data}
Below we present a schema for what data we will collect with its description. The schema consists of two parts The first is statistical data for comparing the two projects(D1-D4). The second part(D5-D)8 is sampling data focusing on requirements elicitation. A more extensive description and technical definition of each data point can be found in Appendix Y\footnote{TODO}.
