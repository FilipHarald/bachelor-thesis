...
\begin{enumerate}
	...
	The search phrase \texttt{acmdlTitle:( +open source  +konventionell  +project  +management  +case studyt)} on \texttt{GOOGLE} within the year span of 2015-2016 resulted in 194 hits. One of the was ~\cite{Jansson2015} which after the second pass we still found relevant and incorporated into the thesis.
	...
	\item \textbf{Outsourcing to an Unknown Workforce: Exploring Opensourcing as a Global Sourcing Strategy}
