...
%Explain Atom
Atom is a free and open-source text and source code editor for macOS, Linux, and Microsoft Windows with support for plug-ins\footnote{Do we need to explain what a plug-in are in this matter? } , and embedded Git Control, developed by GitHub. Atom is a desktop application built using web technologies. Most of the extending packages have free software licenses and are community-built and maintained. Atom was released from beta, as version 1.0, on June 25, 2015. Its developers call it a "hackable text editor for the 21st Century".\cite{https://atom.io/}


\subsubsection{Case 2: NeoVim}
%Explain Neovim
Neovim is a refactor of a highly configurable text editor called Vim. Vim itself are built to make creating and changing any kind of text very efficient and was first released 1991 under a special licens compatible with the GNU General Public License. The Neovim project started in 2014, with some Vim community members offering early support of the high-level refactoring effort to provide better scripting, plugins, and integration with modern GUIs, in december 2015 the release took place. Neovim are focused on unix based system such as macOS and Linux but still offers a unstable version for Windows. \cite{https://neovim.io/, https://github.com/neovim/neovim/wiki}
...
\begin{enumerate}[label=D\arabic*]
	...
	How and where were features first proposed?
...
When conducting a case study it is important to select a case that is representable for the researched phenomenon in order to use the results to draw generalised conclusions. If a representable case is not selected this poses a threat to the external validity of the thesis. To minimise this threat we 
