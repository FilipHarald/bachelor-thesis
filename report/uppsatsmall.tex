...
För belysa nya utvecklingsmetoder och upplysa de som behöver, valde vi att undersöka skillnaderna i krav framställning inom området Open Source Software\footnote{öppen källkod}-utveckling. I vårt arbete ställer tre forskningsfrågor som ska belysa ämnet dessa bevarar vi genom att utföra en fallstudie. I fallstudien undersöker vi hur och av vilka som krav framställts i ett företagsstyrt projekt jämfört med ett projekt drivet av en frivilligorganisation.

Fallstudien visade att externa användare i gemenskapsdrivna OSS-projekt har låg delaktighet jämfört med företagsdrivna projekt där deltagandet av externa användare är högt. Slutligen diskuterar vi de potentiella konsekvenserna av resultaten för både community-och firm-driven OSS-projekt. Vi kan sluta för båda typerna att det är möjligt att öka både utvecklingshastighet och kundproduktvärde.
...
The case study showed that in community driven Open Source Software projects external users have low participation compared to firm-driven projects where the participation of external users is high. Finally, we discuss the potential implications of the findings for both community- and firm-driven OSS projects. We could conclude for both types that it's possible to increase both development speed and customer product value. 
...
In this section we present the results for Feature Origin Categories presented in section~\ref{subsec:data}. The categories are: (A) asserted by a developer, either from his or her personal experience or knowledge of user needs. (B) Proposed by an end-user, for example by posting a request to one of the discussion forums, or filing a bug report or ''Request for Enhancement'' in the issue database. And (C) derived from features found in competing products.
...
In general, participants in an open source software development show a strong sense of engagement in, and ownership of, the project, where the time they spent on contributing to the development in most cases are rewarded with signalling as mentioned in section \ref{subsec:background}. In the case of Atom and Neovim there are no exceptions. However within this engagement among participants we have seen certain differences and similarities within feature proposals, origin, acknowledgement and in the first implementation of a feature among participants.
