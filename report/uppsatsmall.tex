...
Too further prove the liability in the Github sample data we have also turned to Atom and Neovims forums for development discussions. Within these forums proposals for features and issues alongside with instructions and tips to the users can be found. Atom uses its own discussion forum that can be found on their official website\cite{atomwebsite}. Neovim on the other hand use Reddit\{neovimreddit}, a social news aggregation, web content rating, and discussion website, and Github as discussion channels. The gathering of this sample data are presented in section \ref{subsec:data}
...
For the specified timespan\footnote{TODO: define!} Atom had 303 and Neovim 176 issues with the label bug. 
\begin{table}[h]
	\centering
	\begin{tabular}{ | l | c | c | }
		\hline
...
\begin{table}[h]
	...
	\begin{tabular}{ | l | c | c | }
		...
		feature proposals 		& 1 			& 1 				\\\hline
		categories A	 		& 1			& 1 				\\\hline
		categories B	 		& 1			& 1 				\\\hline
		categories C	 		& 1			& 1 				\\\hline
		core devs	 			& 1			& 1 				\\\hline
		devs	 				& 1			& 1 				\\\hline						
		end-users(proposers)	& 1			& 1				\\
		\hline
	\end{tabular}
	\caption{Showing amount of users in user groups.}
\end{table}
\FloatBarrier
...
\begin{table}[h]
	...
	\begin{tabular}{ | l | c | c | }
		...
		karai17	 		& 1		 				& end-user			\\\hline
		50Wliu 			& 0  						& core dev.			\\\hline
		as-cii	 			& 0		 				& core dev.			\\\hline
		simurai	 		& 0		 				& core dev.			\\\hline
		wil93				& 0		 				& core dev			\\\hline
		kuychaco	 		& 0		 				& core dev.			\\\hline
		lee-dohm	 		& 0		 				& core dev.			\\\hline
		izuzak	 		& 0		 				& core dev.			\\\hline
		bastilian	 		& 0		 				& dev.				\\\hline
		benogle	 		& 0		 				& dev.				\\\hline
		danjordan	 		& 0		 				& dev.				\\\hline
		esdoppio	 		& 0		 				& dev.				\\\hline
		jtokoph	 		& 0		 				& dev.				\\\hline
		nathansobo	 	& 0		 				& dev.				\\\hline
		svanharmelen	 	& 0		 				& dev.				\\\hline
		timkelty	 		& 0		 				& dev.				\\
...
\begin{table}[h]
	...
	\begin{tabular}{ | l | c | c | }
		...
		mmlb 			& 1  						& end-user.			\\\hline
		mhinz 			& 0  						& core dev.			\\\hline
		alexgenco			& 0		 				& dev.				\\\hline
		tjdevries			& 0		 				& dev.				\\
		\hline
	\end{tabular}
...
\begin{table}[h]
	...
	\begin{tabular}{ | l | c | c | c | c |}
		\hline
		\textbf{Proposal Category} 	& \textbf{Atom} 	& \textbf{Neovim}	& \textbf{User Need}			& \textbf{Developer Experience} 	\\\hline
		A						& 1 			& 1				& 1						& 0					\\\hline
		B		 				& 1			& 1 				& 0						& 1		 			\\\hline
		C						& 1			& 1				& 1						& 1					\\
		\hline
...
\begin{table}[h]
	...
	\begin{tabular}{ | l | c | c | }
		\hline
		\textbf{Username} 	& \textbf{Feature Acknowledgements}	& \textbf{User Status}	\\\hline
		NeoTeddy 		& 2  								& core dev.			\\\hline
		NeoFilip			& 3		 						& dev.				\\\hline
		Last				& 1		 						& end-user			\\
		\hline
	\end{tabular}
