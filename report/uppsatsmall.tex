...
\begin{enumerate}[label=RQ\arabic*]
	...
	\item \emph{How can software companies benefit ?}
\end{enumerate}
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
\newpage
\section{Methodology}
...
% discuss RQ3ß
This would imply that for firms engaging in OSS development they could reduce their development costs by reducing the amount of required developer resources. However it is important to note that the firm still needs to spend the same or more resources on managing the project because there are contributions made by external users.
